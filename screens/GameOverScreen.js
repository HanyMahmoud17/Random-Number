...
function GameOverScreen({startNewGame,userNumber,numberOfRounded}){
    return (
     <View style={styles.rootContainer}>
        ...
        <Text style={styles.summeryText}>Your phone needed <Text style={styles.highlightText}>{userNumber}</Text> rounds to guess the number <Text style={styles.highlightText}>{numberOfRounded}</Text>.</Text>
